...
public:
	GameObject(std::string Mesh_Path, std::string Vert_Path, std::string Frag_Path, glm::vec4 color);
	~GameObject();

	void Draw(glm::mat4 identity_matrix, glm::mat4 projection_matrix, physics::MyVector position);
